...
namespace OpenTK
{
    ...
    public struct ContextHandle : IComparable<ContextHandle>, IEquatable<ContextHandle>
    {
        ...
        #endregion public static explicit operator IntPtr(ContextHandle c)
        ...
        #endregion public static explicit operator ContextHandle(IntPtr p)

        #region public static Boolean operator ==(ContextHandle left, ContextHandle right)
        ...
        #endregion public static Boolean operator ==(ContextHandle left, ContextHandle right)
        ...
        #endregion IComparable<ContextHandle> Members
        ...
        #endregion IEquatable<ContextHandle> Members
    }
}