...
{
    public class TSnubDodecahedron : TInternal
    {
        #region Public Fields

        public const float CrossDelta = 0.01F;

        public TFacet[] Facets = { };
        ...
        public override void LaunchLoad()
        {
            ...
            grp.Dispose();
            Texture.KDBitmap.Save("c:\\temp\\tmp.png", System.Drawing.Imaging.ImageFormat.Png);
            //
            ...
            for (int nbSplit = 0; nbSplit < 2; nbSplit++)
            {
